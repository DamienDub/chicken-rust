...
pub fn test() -> Html {
    let onclick = Callback::from(move |_: MouseEvent| {
        ...
        // URL encoding
        assert_eq!(
            url_decode("http%3A%2F%2Furl.com%2Fa%20b%20c"),
            "http://url.com/a b c"
        );
        ...
        assert_eq!(
            aes_cbc_encrypt(128, key_128, iv, "Hey Doc", false),
        ...
        assert_eq!(
            aes_cbc_decrypt(128, key_128, iv, "iYb0EyQStjUulA4sfAA4jw==", false),
            "Hey Doc"
        );
        ...
        assert_eq!(
            aes_cbc_encrypt(192, key_192, iv, "Hey Doc", false),
        ...
        assert_eq!(
            aes_cbc_decrypt(192, key_192, iv, "3wviCl5mie4Ub4sS7X7STw==", false),
            "Hey Doc"
        );
        ...
        assert_eq!(
            aes_cbc_encrypt(256, key_256, iv, "Hey Doc", false),
        ...
        assert_eq!(
            aes_cbc_decrypt(256, key_256, iv, "1wI8/eKQIzIRSdm+eSx4kw==", false),
            "Hey Doc"
        );
        ...
        assert_eq!(
            aes_ecb_encrypt(128, key_128, "Hey Doc", false),
            "iYb0EyQStjUulA4sfAA4jw=="
        );
        ...
        assert_eq!(
            aes_ecb_decrypt(128, key_128, "iYb0EyQStjUulA4sfAA4jw==", false),
            "Hey Doc"
        );
        ...
        assert_eq!(
            aes_ecb_encrypt(192, key_192, "Hey Doc", false),
            "3wviCl5mie4Ub4sS7X7STw=="
        );
        ...
        assert_eq!(
            aes_ecb_decrypt(192, key_192, "3wviCl5mie4Ub4sS7X7STw==", false),
            "Hey Doc"
        );
        ...
        assert_eq!(
            aes_ecb_encrypt(256, key_256, "Hey Doc", false),
            "1wI8/eKQIzIRSdm+eSx4kw=="
        );
        ...
        assert_eq!(
            aes_ecb_decrypt(256, key_256, "1wI8/eKQIzIRSdm+eSx4kw==", false),
            "Hey Doc"
        );
